...
exports.EmailValidationRule = exports.MinimumLengthLimit = exports.CantStartNumber = exports.CantContainWhitespace = exports.RequireRule = void 0;
exports.RequireRule = {
  rule: /.+/,
  match: true,
  message: '필수 입력 항목입니다.'
...
function () {
  function App(container, data) {
    ...
    this.initialize = function () {
      ...
      emailField.addValidateRule(constant_1.EmailValidationRule);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "6937" + '/');
